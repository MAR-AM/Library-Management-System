...
class Buy_2:
    def __init__(self, root):
        ...
        self.Quantity_entry = StringVar(value=1)
        ...
        # Aresse = Label(Frame_Buy_Now,bg="#CDB5CD",text="Quantity : ",font=("times new roman",16,"bold"),fg="#483D8B",padx=2,pady=6)
        # Aresse.place(x=560,y=260,width=210,height=30)
        # Aresse_entry=Entry(Frame_Buy_Now,bg="#CDB5CD",textvariable=self.Quantity_entry,font=("times new roman",16,"bold"))
        # Aresse_entry.place(x=730,y=260,width=120,height=30)
        ...
        final_price.place(x=610, y=300, width=130, height=30)
        total = 119.99 
        final_price_entry = Label(Frame_Buy_Now, text=(total, "DH"), font=("times new roman", 16), bg="#CDB5CD", width=24)
        final_price_entry.place(x=730, y=300, width=130, height=30)
        ...
        Confirm.place(x=618,y=350,width=230,height=45)
        ...
        Exit.place(x=618,y=410,width=230,height=45)
    ...
    def confirmation(self):
        ...
        if self.TypeMember.get()=='':
            ...
            messagebox.showinfo("Success","The order has been completed successfully")


        # global total 
        # # Calculate the total based on the quantity entered
        # quantity = int(Aresse_entry.get())
        # total = 119.99 * quantity  
        # # final_price_entry.config(text=(total, "DH"))  
